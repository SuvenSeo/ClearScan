...
fun ClearScanApp(
    ...
    onShareDocumentImages: (ScanDocument) -> Unit,
    onExportText: (ScanDocument) -> Unit,
    onExportDocx: (ScanDocument) -> Unit,
    ...
    onRenameDocument: (ScanDocument, String) -> Unit,
    ...
    if (!isWide || state.expandedDocumentId == null) {
        selectedDocument?.let { document ->
            ...
            DocumentDetailSheet(
                ...
                onShareImages = { onShareDocumentImages(currentDocument) },
                onExportText = { onExportText(currentDocument) },
                onExportDocx = { onExportDocx(currentDocument) },
                ...
                onRename = { title -> onRenameDocument(currentDocument, title) },
